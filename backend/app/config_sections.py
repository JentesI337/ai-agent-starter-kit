...
class PromptsSection(BaseModel):
    ...
    researcher_agent_plan_prompt: str = ""
    ...
    architect_agent_plan_prompt: str = ""
    ...
    security_agent_plan_prompt: str = ""
    ...
    refactor_agent_plan_prompt: str = ""
    ...
    healthtech_agent_plan_prompt: str = ""
    ...
    legaltech_agent_plan_prompt: str = ""
    ...
    ecommerce_agent_plan_prompt: str = ""
    ...
    industrytech_agent_plan_prompt: str = ""
