...
export class ArchitecturePageComponent implements OnInit, OnDestroy {
  ...
  readonly phases: PipelinePhase[] = [
    ...
    { id: 'planning',       label: 'Planning',           icon: '◈', color: '#00cc7a', desc: 'Intent detection, task decomposition, strategy selection' },
    { id: 'tool_select',    label: 'Tool Selection',     icon: '⬡', color: '#3794ff', desc: 'LLM decides which tools to invoke based on the plan' },
    { id: 'tool_exec',      label: 'Tool Execution',     icon: '▣', color: '#ffb347', desc: 'Budget-controlled execution with loop detection and retries' },
    { id: 'synthesis',      label: 'Synthesis',          icon: '◉', color: '#00cc7a', desc: 'Combines tool results into coherent response' },
